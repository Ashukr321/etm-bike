      ...
      <section>
        ...
        <div class="container  mx-auto">
          ...
          <div class="flex flex-wrap  -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div class=" md:w-1/3 flex flex-col text-center items-center" data-aos="flip-up">
            ...
            <div class="p-4 md:w-1/3 flex flex-col text-center items-center" data-aos="flip-up">
              <div class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
                {/* logo icons */}
