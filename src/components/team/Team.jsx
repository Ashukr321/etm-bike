      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 class="mb-4 text-5xl tracking-tight font-bold text-gray-900 dark:text-white">
              OUR TEAM
            </h2>
            <p class="font-light w-full text-gray-500 sm:text-xl dark:text-gray-400">
          ...
          <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
            <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 ">
                <Link
                  to="https://www.linkedin.com/in/ravi-shekhar-090bb932/"
                  target="_blank"
                >
                  Ravi Shekhar
                </Link>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <Link
                  to="https://www.linkedin.com/in/kartikeshkumarjha/"
                  target="_blank"
                >
                  Kartikesh Kumar Jha
                </Link>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              ...
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <Link
                  to="https://www.linkedin.com/in/dheeraj-kr-cs/"
                  target="_blank"
                >
                  Dheeraj Kumar
                </Link>
